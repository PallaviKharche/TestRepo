...
angular.module('bahmni.clinical')
    .service('dischargeSummuryService', ['$rootScope', '$translate', 'patientService', 'observationsService', 'programService', 'treatmentService', 'localeService', 'patientVisitHistoryService', 'conceptSetService','diagnosisService','labOrderResultService',
        function ($rootScope, $translate, patientService, observationsService, programService, treatmentService, localeService, patientVisitHistoryService, conceptSetService,diagnosisService, labOrderResultService) {
            var count = 0;
            var reportModel = {
